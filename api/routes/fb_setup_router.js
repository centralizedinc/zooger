 ...
 *  setup all route
 */
fb_setup_router.route("/").get((req, res) => {
    var responses = [];
 ...
 */
fb_setup_router.route("/getStarted").get((req, res) => {
 ...
 */
fb_setup_router.route("/persistentMenu").get((req, res) => {
 ...
 */
fb_setup_router.route("/whiteList").get((req, res) => {
 ...
 * setup db tables
 */
fb_setup_router.route("/db").get((req, res) => {
    ...
    var json = {
        persistent_menu: [{
                ...
                call_to_actions: [{
                    ...
                    {
                        title: "🗺 Explore Zoobic",
                        type: "postback",
                        payload: "MAP"
                    },
                    // {
                    //     title: "🗣 Talk with my hooman",
                    //     type: "postback",
                    //     payload: "AGENT"
                    // }
                    {
                        title: "🗣 Chat with my hooman",
                        type: "nested",
                        call_to_actions: [{
